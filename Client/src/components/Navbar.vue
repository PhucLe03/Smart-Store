<template>
    <template v-if="showStudentBoard">
        <nav class="bg-white border-gray-200" style="font-family: 'Comfortaa';">
            <div class="max-w-screen-xl flex flex-wrap justify-between items-center mx-auto p-4">
                <!-- Brand -->
                <a style="color: #00CDE8;">
                <span class="self-center text-lg font-semibold whitespace-nowrap mr-12">SmartKonbini</span>
                </a>

                <!-- Begin notifications -->
                <div class="relative flex flex-col items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button @click="tdNotif" class="relative inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none" type="button">
                    ...
                    <!-- Dropdown menu -->
                    <div v-show="ddNotif" class="absolute z-999 mt-8 w-96">
                        <div class="z-20 w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow">
                            ...
                            <!-- Content -->
                            <a class="flex px-4 py-3 hover:bg-gray-100">
                                <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11" src="/images/system.png" alt="System">
                                <div class="absolute flex items-center justify-center w-5 h-5 ms-6 -mt-5 bg-green-400 border border-white rounded-full">
                                    <svg class="w-2 h-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                                    </svg>
                                </div>
                                </div>
                                <div class="w-full ps-3">
                                    <div class="text-gray-500 text-sm mb-1.5">System is online again!</div>
                                    <div class="text-xs text-blue-600">12 hours ago</div>
                                </div>
                            </a>
                            ...
                            <a class="flex px-4 py-3 hover:bg-gray-100">
                                <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11" src="/images/system.png" alt="System">
                                <div class="absolute flex items-center justify-center w-5 h-5 ms-6 -mt-5 bg-red-500 border border-white rounded-full">
                                    <svg class="w-2 h-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                ...
                                <div class="w-full ps-3">
                                    <div class="text-gray-500 text-sm mb-1.5">System is down for maintenance, sorry for the inconvenience.</div>
                                    <div class="text-xs text-blue-600">15 hours ago</div>
                                </div>
                            </a>
                            </div>

                            <a class="block py-2 text-sm font-medium text-center text-gray-900 rounded-b-lg bg-gray-50 hover:bg-gray-100">
                ...
                <!-- Begin user profile -->
                <div class="relative flex flex-col items-center md:order-3 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button @click="tdAvatar" type="button" class="relative flex text-sm bg-transparent rounded-full md:me-0 hover:ring-2 hover:ring-gray-300" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    <span class="sr-only">Open user menu</span>
                    <img class="w-8 h-8 rounded-full" src="/images/profile.png" alt="user photo">
                </button>
                
                <!-- Dropdown menu -->
                    <div v-show="ddAvatar" class="absolute z-50 mt-8 w-72">
                        <div class="z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow" id="user-dropdown" style="font-family: 'Comfortaa'; width: 300px;">
                            ...
                            <li class="hover:bg-gray-100">
                                ...
                                <svg class="w-3.5 h-3.5 mr-2" aria-hidden="true" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="hover:bg-gray-100">
                                <a @click="logOut()" class="block inline-flex items-center px-4 py-2 text-sm text-gray-700">
                ...
                <!-- Begin get more papers-->
                <div class="flex md:order-4 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button data-collapse-toggle="navbar-user" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-cta" aria-expanded="false">
                ...
                <!-- Begin navlinks -->
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user" style="margin-right: 175px;">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                    <li style="margin-right: 20px;">
                    <router-link to="/student" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">
                        Home
                    </router-link>
                    </li>
                    <li style="margin-right: 20px;">
                    <router-link to="/about" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">
                        About
                    </router-link>
                    </li>
                    <li style="margin-right: 20px;">
    ...
    <template v-else-if="showOispBoard">
        <nav class="bg-white border-gray-200" style="font-family: 'Comfortaa';">
            <div class="max-w-screen-xl flex flex-wrap justify-between items-center mx-auto p-4">
                <!-- Brand -->
                <a style="color: #00CDE8;">
                <span class="self-center text-lg font-semibold whitespace-nowrap mr-12">Galacticos</span>
                </a>

                <!-- Begin notifications -->
                <div class="relative flex flex-col items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse md:ml-72">
                    <button @click="tdNotif" class="relative inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none" type="button">
                        <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 20">
                        <path d="M12.133 10.632v-1.8A5.406 5.406 0 0 0 7.979 3.57.946.946 0 0 0 8 3.464V1.1a1 1 0 0 0-2 0v2.364a.946.946 0 0 0 .021.106 5.406 5.406 0 0 0-4.154 5.262v1.8C1.867 13.018 0 13.614 0 14.807 0 15.4 0 16 .538 16h12.924C14 16 14 15.4 14 14.807c0-1.193-1.867-1.789-1.867-4.175ZM3.823 17a3.453 3.453 0 0 0 6.354 0H3.823Z"/>
                        </svg>
                ...
                <!-- Begin user profile -->
                <div class="relative flex flex-col items-center md:order-3 space-x-3 md:space-x-0 rtl:space-x-reverse md:mr-10">
                <button @click="tdAvatar" type="button" class="flex text-sm bg-transparent rounded-full md:me-0 hover:ring-2 hovers:ring-gray-300" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    <span class="sr-only">Open user menu</span>
                    <img class="w-8 h-8 rounded-full" src="/images/system.png" alt="user photo">
                </button>
                
                <!-- Dropdown menu -->
                <div v-show="ddAvatar" class="absolute z-999 mt-8 w-72">
                <div class="z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow" id="user-dropdown" style="font-family: 'Comfortaa'; width: 300px;">
                    <div class="px-4 py-3 flex items-center">
                    ...
                    <div>
                        ...
                        <div class="px-4 py-2 text-sm"> 
                            <span class="font-bold">OISP Code: </span> {{currentUser.OISPCode}}
                        </div>
                    </div>
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                        <li style="margin-right: 20px;">
                        <router-link to="/admin" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Home</router-link>
                        </li>
                        <li style="margin-right: 20px;">
                        <router-link to="/match" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Matching</router-link>
                        </li>
                        <li style="margin-right: 20px;">
                        <router-link to="/buddy-result" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Buddy Result</router-link>
                        </li>   
                        <li style="margin-right: 20px;">
                        <router-link to="/announcement" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Announcement</router-link>
                        </li>     
                    </ul>
                </div>
                <!-- End navlinks-->
    ...
    <template v-else-if="$route.path === '/'">
        <nav style="font-family: 'Comfortaa'; background-color: #303030;">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <span class="self-center text-xl font-semibold whitespace-nowrap">SmartKonbini</span>
                </a>
                ...
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-transparent">
                    ...
                    <li style="margin-right: 20px;">
                    <router-link to="/login" style="padding: 6px 8px;" class="block text-white rounded-full transition duration-300 ease-in-out md:hover:bg-gray-200 md:hover:text-gray-900 md:p-0">
                        Sign in
                    </router-link>
                    </li>
                    <li style="margin-right: 20px;">
                    <router-link to="/register" style="padding: 6px 8px;" class="block text-white rounded-full transition duration-300 ease-in-out md:hover:bg-gray-200 md:hover:text-gray-900 md:p-0">
                        Sign up
                    </router-link>
                    </li> 
                </ul>
    ...
    <template v-else>
        <nav class="bg-transparent" style="font-family: 'Comfortaa';">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <!-- Brand -->
                <a style="color: #00CDE8; margin-right: 50px;">
                <span class="self-center text-lg font-semibold whitespace-nowrap">SmartKonbini</span>
                </a>
                ...
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-transparent">
                    ...
                    <li style="margin-right: 20px;">
                    <router-link to="/login" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">
                        Sign in
                    </router-link>
                    </li>
                    <li style="margin-right: 20px;">
                    <router-link to="/register" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">
                        Sign up
                    </router-link>
                    </li> 
                </ul>
...
export default {
    computed: {
      ...
      showOispBoard() {
        if (this.currentUser && this.currentUser.role) {
          return this.currentUser.role === 'ROLE_OISP';
        }
